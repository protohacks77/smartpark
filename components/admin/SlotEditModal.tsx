...
const SlotEditModal = ({ isOpen, onClose, onSave, slot, lotLocation, existingSlotIds }: SlotEditModalProps) => {
  ...
  // Track if the modal has been initialized to prevent resetting form data
  ...
  useEffect(() => {
    if (isOpen && !isInitialized) {
      ...
      } else { // Adding new slot - empty values
        setFormData({
          id: '',
          lat: '',
          lng: '',
  ...
  }, [isOpen, slot, lotLocation, isInitialized]);
        ...
        <div className="relative p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-4 pt-4">
              ...
              <button 
                type="submit" 
                className="flex-1 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-bold py-3 px-4 rounded-lg transition-transform hover:scale-105"
              >
                Save Slot
              </button>
            </div>
